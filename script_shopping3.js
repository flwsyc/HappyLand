document.addEventListener("DOMContentLoaded", function () {
    const closetItems = document.querySelectorAll(".closet1, .closet2, .closet3, .closet4");
    ...
    const contentMap = {
        ...
        "closet2": `
            <div class="new-content" id="new-closet2">
                <div class="new-title">
                    <div class="new-title-image"><img src="img/shopping/tshirt-detail3.png"></div>
        ...
        "closet3": `
            <div class="new-content" id="new-closet3">
                <div class="new-title">
                    <div class="new-title-image"><img src="img/shopping/train-detail.png"></div>
                    <div class="new-title-heading"><h3>HAPPY  TRAIN  MODEL</h3></div>
                </div>
                <div class="new-details">
                    <h4>$ 45.99</h4>
                    <img src="img/shopping/star.png" id="star">
                    <p>A train that always runs on time—straight to the gift shop.</p>
                </div>
                <div class="new-cart">
                    <img src="img/shopping/addcart.png" class="addcart">
                </div>
        ...
        "closet4": `
            <div class="new-content" id="new-closet4">
                <div class="new-title">
                    <div class="new-title-image"><img src="img/shopping/cup-detail3.png"></div>
